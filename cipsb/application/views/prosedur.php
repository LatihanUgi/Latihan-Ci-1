<div class="container" class="prosedur">
    ...
    <ol>
        <li>
            <strong>Pendaftaran.</strong> Calon peserta melakukan pendaftaran pada website PSB Online, melalui halaman
        ...
        <li>
            ...
            Biodata dan nilai yang sudah dicetak tersebut selajutnya dibawa ke Panitia PSB SMP Putih Biru untuk diverifikasi.
        </li>
        <li>
            ...
            sekretariat PSB di SMP Putih Biru dan melengkapi semua berkas yang diperlukan. Petugas akan memeriksa
        ...
        <li>
            <strong>Her-registrasi.</strong> Peserta yang dinyatakan LULUS Ujian Seleksi, melakukan Her-registrasi dengan mendatangi Sekretariat PSB di SMP Putih Biru.
